/****************************************************************************
** Meta object code from reading C++ file 'wait.h'
**
...
#include "../../../../Autopatch_5.0 - DEMO/src/states/wait.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'wait.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Wait_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Wait_t qt_meta_stringdata_Wait = {
    {
QT_MOC_LITERAL(0, 0, 4), // "Wait"
QT_MOC_LITERAL(1, 5, 14), // "timer1_timeout"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "pauseState"
QT_MOC_LITERAL(4, 32, 7), // "toggled"
QT_MOC_LITERAL(5, 40, 9) // "haltState"

    },
    "Wait\0timer1_timeout\0\0pauseState\0toggled\0"
    "haltState"
};
...
const QMetaObject Wait::staticMetaObject = {
    { &State::staticMetaObject, qt_meta_stringdata_Wait.data,
      qt_meta_data_Wait,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Wait::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Wait.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyCamera_t, stringdata) + ofs \
...
void MyCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->move((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyCamera::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyCamera::move)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyCamera::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyCamera.data,
      qt_meta_data_MyCamera,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyCamera.stringdata))
